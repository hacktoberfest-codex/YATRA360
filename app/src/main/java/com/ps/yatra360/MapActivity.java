...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng delhiLatLng = new LatLng(20.24811936715895, 85.80219702893264); // Bansuri coordinates
        LatLng haryanaLatLng = new LatLng(20.24783418557049, 85.80123567086278); // E Block coordinates
        LatLng gurugramLatLng = new LatLng(20.24879434926989, 85.80107513143706); // Cafeteria coordinates
    ...
    private void setupShowRouteButton() {
        ...
        showRouteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (haryanaMarker != null) {
                    LatLng delhiLatLng = new LatLng(20.249243, 85.801250); // Bansuri coordinates
    ...
    private void calculateDirections(LatLng origin, LatLng destination) {
        PolylineOptions polylineOptions = new PolylineOptions()
                ...
                .add(new LatLng(20.24879434926989, 85.80107513143706))
